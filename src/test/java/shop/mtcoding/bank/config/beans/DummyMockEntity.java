package shop.mtcoding.bank.config.beans;

public class DummyMockEntity {
    ...
    // try {
    // Account accountCopy = om.readValue(om.writeValueAsString(account),
    // Account.class);
    // return accountCopy;
    // } catch (Exception e) {
    // throw new RuntimeException("서비스 테스트시 깊은 복사 실패 : " + e.getMessage());
    ...
    // om.readValue(om.writeValueAsString(transaction), Transaction.class);
    ...
    // protected Account newAccount(Long id, Long number, String ownername, User
    // user) {
    ...
    // protected Transaction newWithdrawTransaction(Long id, Long amount, Account
    // withdrawAccount) {
    ...
    // protected Transaction newDepositTransaction(Long id, Long amount, Account
    // depositAccount) {
    ...
    // protected Transaction newTransferTransaction(Long id, Long amount, Account
    // withdrawAccount,
